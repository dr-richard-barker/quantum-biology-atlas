...
Three of the five demonstrations needed a different identifier route, and each wrong
...
Five demonstrations span three provenance classes, which the atlas labels separately
...
Two are worth naming. OSD-27 places a plant-anchored ontology on \emph{Drosophila} in a
...
the hormone/circadian map that no repository dataset does.
